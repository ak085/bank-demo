...
DEFAULT_IMPORT_PASSWORD = os.getenv("DEFAULT_IMPORT_PASSWORD", "Bank@123")
...
def expiry_date_to_utc(expiry_date: Optional[str]) -> Optional[str]:
    """Convert a 'YYYY-MM-DD' local (Asia/Singapore) calendar date into the UTC
...
class CreateUser(BaseModel):
    ...
    display_name:        str
    role:                str = "viewer"
    password_expires_at: Optional[str] = None  # 'YYYY-MM-DD', local (Asia/Singapore) date
